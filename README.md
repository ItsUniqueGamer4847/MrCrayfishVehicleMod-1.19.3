...
# Note: This is an unofficial port of mrcrayfish's vehicle mod for 1.19.3. please do not report any bugs on mrcrayfish's social platforms or discord or directly to him. To report any bugs join our discord server at: https://placeholder.gg/ghgv.

# copyright note: The mod ' Mrcrayfish's vehicle's mod' is a property of mrcrayfish. all of the texture files are copyrighted property of mrcrayfish and he has the full right to take down or distribute this port anywhere and that the mod port is for non profit use to support 1.19.3 and should not be distributed for profit anywhere.
